...
public class PlaceReviewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PlaceReviewsActivity.this,AddPlaceReviewActivity. class);
    ...
    private void get_review_list() {
        ...
        firestore.collection("places")
                .document(place_id).collection("reviews")
                .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PlaceReviewsActivity.this,"Failed to get reviews" , Toast.LENGTH_LONG).show();
                        dialog.dismiss();
                    }
                });
    }
