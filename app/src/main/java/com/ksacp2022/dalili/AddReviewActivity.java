                                ...
                                firestore.collection("reviews")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                dialog.dismiss();
                                                Toast.makeText(AddReviewActivity.this,"Thanks for adding your review" , Toast.LENGTH_LONG).show();
                                            finish();
                                            }
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                dialog.dismiss();
                                                Toast.makeText(AddReviewActivity.this,"Fail to save review" , Toast.LENGTH_LONG).show();
